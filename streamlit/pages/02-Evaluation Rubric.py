...
| Did the student deploy the model in production (as an API or embedded solution)?           | ✅ - We can observe the result in the [README.md ](../README.md) file using streamlit.                                                                                                                                                                     |
